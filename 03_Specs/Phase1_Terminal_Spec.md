...
- [ ] Створити CSS змінні для кольорів
- [ ] Налаштувати Tailwind config з готовими кольорами (retro palette)
- [ ] Налаштувати шрифти з підтримкою кирилиці
- [ ] Створити базові компоненти з clsx/tailwind-merge (Button, Input, Card)
- [ ] Імплементувати terminal typing анімацію
- [ ] Додати cursor blink ефект
